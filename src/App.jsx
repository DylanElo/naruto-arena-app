...
function App() {
  ...
  const fullTeamAnalysis = useMemo(() => {
    // Bolt: Gate expensive analysis behind active view state
    if (activeTab !== 'builder') return {}
    return analyzeTeam(selectedTeam)
  }, [selectedTeam, activeTab])

  const suggestions = useMemo(() => {
    // Bolt: Gate expensive suggestions behind active view state
    if (activeTab !== 'builder') return []
  ...
  const filteredCharacters = useMemo(() => {
    // Bolt: Gate filtering behind active view state and hoist search
    if (activeTab !== 'builder') return []
