            ...
            <div className="lg:col-span-8 space-y-6">
              ...
              <div className="glass-panel p-4 rounded-lg flex flex-col md:flex-row gap-4 items-center">
                <div className="relative w-full md:w-auto flex-1">
                  ...
                  />
                  <div className="absolute left-3 top-2.5 text-gray-500 pointer-events-none" aria-hidden="true"><Icons.Search /></div>
                  {search && (
                    <button
                      onClick={() => { setSearch(''); searchInputRef.current?.focus() }}
                      className="absolute right-3 top-2.5 text-gray-500 hover:text-white focus:outline-none focus:text-white"
